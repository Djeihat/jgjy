...
- Newly activated Census API keys take a few minutes to propagate — an
  "Invalid Key" error right after activation usually just means wait and retry.
- Never commit the Census API key to the repo.
